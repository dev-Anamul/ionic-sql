import { ProductStorageService } from './../storages/product-storage.service';
...
export class InitializeAppService {
  ...
  constructor(
    ...
    private storageService: StorageService // private productStorageService: ProductStorageService
  ) {}
